...
for thr in thresholds:
    ...
    for p in with_audio:
        ...
        res=detect_sections(audio,chords=None,weights=weights,min_section_sec=min_sec,nms_gap_sec=nms,beat_snap_sec=beat,algorithm='heuristic',prob_threshold=thr,downbeat_confidence_thresh=0.0)
